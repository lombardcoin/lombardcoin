...
const string strMessageMagic = "LombardCoin Signed Message:\n";
...
{
    int64 nSubsidy = 62 * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 4 * 60 * 60; // LombardCoin: 4 Hours
static const int64 nTargetSpacing = 120; // LombardCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal lombardcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LombardCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd0f94a71867455ba0bb15b742fcf57d242d3462b33dddeb39399cf3fe1e64f12");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Mon, 03 Feb 2014 16:20:25 GMT";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1391444427; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1391444427;
            block.nNonce   = 511698;
        }
        ...
        assert(block.hashMerkleRoot == uint256("7025796c105345f71eb873d4d39713674c66904ed61a07722d5f8324972c5aca"));
